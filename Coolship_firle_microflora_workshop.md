...
```
guppy_basecaller -r --input_path coolship1 --save_path coolship1_fastq --qscore_filtering --min_qscore 7 --cpu_threads_per_caller 4 --num_callers 2 --flowcell FLO-MIN106 --kit SQK-LSK109
```


Guppy high_accuracy basecalling:
```
guppy_basecaller -r --input_path coolship1 --save_path coolship1_fastq_hq --config dna_r9.4.1_450bps_hac.cfg  --qscore_filtering --min_qscore 7 --cpu_threads_per_caller 4 --num_callers 2 --flowcell FLO-MIN106 --kit SQK-LSK109
